...
export default function Resume() {
    return (
        <div style={styles.mainDivStyles}>
            <h1 style={styles.titleStyles}><a style={styles.anchorStyles} href='https://docs.google.com/document/d/1GSe6eq7my1bz4G9xNdjcqu5d4ITHPUhMZL1B0gTZp-s/edit?usp=sharing'>Resume</a></h1>
            <p>
            ...
            <h2 style={styles.subtitleStyles}>Skills</h2>
